export const getEditProductModalTemplate = () => `
  <div id="edit-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-[rgba(10,10,15,0.85)] backdrop-blur-[6px]">
    <div class="bg-[#111118] border border-[#252535] rounded-2xl shadow-2xl w-full max-w-lg mx-4
      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-[#1a1a26] sticky top-0 bg-[#111118] z-10">
        <h3 class="font-display font-bold text-lg text-white">Modifier le produit</h3>
      ...
      <div class="px-6 py-5 space-y-4">
        <div>
          ...
          <input id="edit-f-label" type="text" placeholder="Nom du produit"
        ...
        <div>
          ...
          <textarea id="edit-f-description" rows="3" placeholder="Décrivez le produit..."
            class="w-full px-4 py-2.5 rounded-xl bg-[#1a1a26] border border-[#252535]
                   text-white placeholder-zinc-600 text-sm focus:outline-none
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input id="edit-f-price" type="number" min="0" step="0.01" placeholder="0.00"
              class="w-full px-4 py-2.5 rounded-xl bg-[#1a1a26] border border-[#252535]
                     text-white placeholder-zinc-600 text-sm focus:outline-none
                     focus:border-[#c8f04a88] focus:ring-1 focus:ring-[#c8f04a22] transition-all duration-200" />
          </div>
        ...
        <div>
          ...
          <div class="border-2 border-dashed border-[#252535] rounded-xl p-5 text-center
            ...
            <input id="edit-f-images" type="file" accept="image/*" multiple
          ...
          <div id="edit-image-previews" class="flex flex-wrap gap-2 mt-2"></div>
        </div>
        <p id="edit-form-error" class="hidden text-red-400 text-xs py-2 px-3 rounded-lg bg-red-500/10 border border-red-500/20"></p>
